...
import com.oneclouder.pidm.t_user.model.AssociationUnit_t;
...
public class User_t {
     ...
     * 指定联系人
     */
    private CompanyEmployee_t designatedContact;
     ...
     * 所加协会单位
     */
    private AssociationUnit_t associationUnit;
...
//    private CompanyEmployee cpnyAcstRep;
    ...
    public Company_t getCompany() {
        return company;
    }

    public void setCompany(Company_t company) {
        this.company = company;
    }

    public AssociationUnit_t getAssociationUnit() {
        return associationUnit;
    }

    public void setAssociationUnit(AssociationUnit_t associationUnit) {
    ...
    public CompanyEmployee_t getDesignatedContact() {
        return designatedContact;
    }

    public void setDesignatedContact(CompanyEmployee_t designatedContact) {
