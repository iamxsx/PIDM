...
$("#register-form").validate({
    rules: {
        ...
        "introduceds[2].name": {},
        "introduceds[2].jobPosition": {
            // dependentName1: true,
        },
        "introduceds[2].asctJobPosition": {
            // dependentName1: true,
        },
        "introduceds[2].chapterJobPosition": {
            // dependentName1: true,
        },
        "introduceds[2].email": {
            // dependentName1: true,
        ...
        "introduceds[2].officePhoneNum": {
            // dependentName1: true,
            telephone: true,
        },
        "introduceds[2].cellPhoneNum": {
            // dependentName1: true,
            mobile: true,
        },

        "introduceds[3].name": {},
        "introduceds[3].jobPosition": {
            // dependentName1: true,
        },
        "introduceds[3].asctJobPosition": {
            // dependentName1: true,
        },
        "introduceds[3].chapterJobPosition": {
            // dependentName1: true,
        },
        "introduceds[3].email": {
            // dependentName1: true,
        ...
        "introduceds[3].officePhoneNum": {
            // dependentName1: true,
            telephone: true,
        },
        "introduceds[3].cellPhoneNum": {
            // dependentName1: true,
            mobile: true,
        },
        ...
        "designatedContacts[2].jobPosition": {
            // dependentName2: true,
        },
        "designatedContacts[2].officePhoneNum": {
            // dependentName2: true,
            telephone: true,
        },
        "designatedContacts[2].cellPhoneNum": {
            // dependentName2: true,
            mobile: true,
        },
        "designatedContacts[2].email": {
            // dependentName2: true,
            email: true,
        },
        "designatedContacts[2].faxNum": {
            faxNum: true,
        },
        "designatedContacts[2].onlineNum": {
            // dependentName2: true,
            checkLineNum: true,
        },

        "designatedContacts[3].jobPosition": {
            // dependentName2: true,
        },
        "designatedContacts[3].officePhoneNum": {
            // dependentName2: true,
            telephone: true,
        },
        "designatedContacts[3].cellPhoneNum": {
            // dependentName2: true,
            mobile: true,
        },
        "designatedContacts[3].email": {
            // dependentName2: true,
            email: true,
        },
        "designatedContacts[3].faxNum": {
            faxNum: true,
        },
        "designatedContacts[3].onlineNum": {
            // dependentName2: true,
            checkLineNum: true,
        },
...
jQuery.validator.addMethod("join", function (value, element) {
    if ($("input[name='company.associationName']").get(0).checked == true) {
        return true;
    }
    for (var i = 0; i < $("input[name='company.chapterName']").length; i++) {
        if ($("input[name='company.chapterName']").get(i).checked == true) {
            return true;
        }
    }
    return false;
