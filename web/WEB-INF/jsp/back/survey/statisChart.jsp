...
<head>
    ...
    <script src="${ctx}/dist/js/survey/statisChart.js"></script>
...
<div class="col-md-9 right-panel">
    ...
    <hr>
    <div class="btn btn-primary" style="margin: 0 auto;width: 150px;display: block" onclick="overSurveyBtn()" id="overSurveyBtn">结束此份调查问卷</div>
</div>
</body>
<script>
    $(function () {
