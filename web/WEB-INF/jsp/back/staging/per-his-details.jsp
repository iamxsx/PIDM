...
<div class="container-fluid">
    ...
    <div class="row">
        <jsp:include page="front-left.jsp"/>
        <div class="col-md-10" style="font-family: 'Microsoft YaHei';color: black">
            <ol class="breadcrumb">
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
                        <div class="panel-body">
                            <table class="table" id="pending-comment-table"></table>
                        </div>
                    </div>
                </div>
                <div class="panel panel-default">
                    <div class="panel-heading" role="tab" id="headingTwo">
                        <h4 class="panel-title">
                            <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                                <span class="glyphicon glyphicon-tasks"></span>&nbsp;&nbsp;相关业务信息
                            </a>
                        </h4>
                    </div>
...
<script src="${ctx}/dist/controller/staging/pending-details.js"></script>
</html>
