...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="padding: 0px">
                        <img id="img_id">
                        <div id="img_div"style="position: absolute; border: 3px solid red;" id="img_div"></div>
                    </div>
            ...
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="table-responsive" >
                            <table class="table" style="width: 870px;margin:10px auto;border: 1px solid #DDDDDD;" id="comment-tables">
                            </table>
                        </div>
                    </div>
                    <div class="modal-footer">
        ...
        <div style="display: none" class="modal fade bs-example-modal-lg" aria-hidden="true" data-backdrop="static" data-target=".bs-example-modal-lg" id="myModalThr" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog modal-lg my-modal-lg">
                <div class="modal-content" id="print-content">
                    <div class="modal-header">
                        <button style="display:none;" id="close-button" type="button" class="close" data-dismiss="modal"></button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="table-responsive register-box">
                            <table class="table table-bordered page"  id="comment-table">
                            </table>
                        </div>
                        <textarea id="comment" class="form-control" rows="5" style="resize:none;width: 970px;margin: auto"></textarea>
                        <label class="radio-inline" style="margin:10px 37px">
                    ...
                    <div id="div-message" class="alert alert-danger alert-dismissible" role="alert" style="display:none">
                        <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                        <strong>提醒!</strong> 必须填写和选择相关的审核意见！
                    </div>
                    <div class="modal-footer">
                        <div class="btn btn-default" onclick="print()"><span class=" glyphicon glyphicon-print"></span>&nbsp;&nbsp;打印</div>
                        <button type="button" id="qx-button" class="btn btn-default btn-danger" data-dismiss="modal"><span class=" glyphicon glyphicon-remove-circle"></span>&nbsp;&nbsp;取消</button>
...
<script src="${ctx}/dist/controller/staging/to-do-table.js"></script>
