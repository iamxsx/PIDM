...
<head>
    ...
    <link rel="stylesheet" href="${ctx}/dist/css/user/login.css">
...
<div class="login-main">
    ...
    <div class="login-box">
        <div class="login-title">
            ...
            <span style="float: right;color: #357ebd"><a href="${ctx}/register/goto-register">免费注册</a></span>
        </div>
        <form id="login-form" method="post" action="${ctx}/login/login">
            ...
            <div class="l-row clearfix">
                ...
                <div class="f-right">
                    <a href="${ctx}/register/redirect?msg=forget">忘记密码</a>
                </div>
            </div>
            <c:if test="${msg != null}">
...
<footer class="footer clearfix">
    <div class="col-md-12">
        ...
        <%--<img class="footcode" src="${ctx}/imgs/index/code.jpeg">--%>
    </div>
</footer>
