        ...
        <div class="col-md-10 right-panel">
            <div>
                ...
                <div class="input-group input-group-lg">
                    ...
                    <input id="suggestTitle" type="text" class="form-control" placeholder="请输入标题" maxlength="25"
                           onkeyup="javascript:setShowLength(this, 25, 'title_length');" onblur="changeBtn2()">
            ...
            <div>
                <div class="input-group input-group-lg">
                    <textarea id="textareaContent" class="form-control" placeholder="请输入内容"
                              onblur="changeBtn2()"></textarea>
                </div>
            </div>

            <div class="btn btn-primary" style="width: 70px;float: left;margin-bottom: 20px" onclick="submitSuggest()">提交</div>
        </div>
    </div>
</div>
